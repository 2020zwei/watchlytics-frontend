...
const pages = () => {
    return (
        <RoundedBox className='px-4 py-8 '>
            <Heading className=' border-b border-[#F0F1F3] pb-4'>New Invoice</Heading>
                    ...
                    <table className=' w-full'>
                        <thead>
                            <tr className='text-dark-800 font-medium text-sm'>
                                <th className='text-start'><div className='flex-1 px-4'>Product ID</div></th>
                                <th className='text-start'><div className='flex-1'>QTY</div></th>
                                <th className='text-start'><div className='flex-1 pe-5'>Unit Price</div></th>
                                <th className='text-start'> <div className='flex-1'>Amount</div></th>
                            </tr>
                        </thead>
                        <thead className='mt-3 text-dark-700 font-medium text-sm bg-[#003BFF0D] h-10 rounded-lg'>
                            <tr>
                                <th className='text-start w-1/4'><div className='flex-1 px-4'>#edf8918</div></th>
                                ...
                                <th className='text-start w-1/4'><div className='flex-1'>$165.16</div></th>
                            </tr>
                        </thead>
                        <tbody className='font-medium text-sm'>
                            <tr>
                                <td></td>
                                <td></td>
                                <td className=''><div className='text-dark-800'>Subtotal:</div></td>
                                <td className=''><div className='text-dark-700'>$165.16</div></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td></td>
                                <td className=''> <div className='text-dark-800'>Total:</div></td>
                                <td className=''><div className='text-dark-700'>$165.16</div></td>
                            </tr>
                        </tbody>
                    </table>
