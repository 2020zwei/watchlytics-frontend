                        ...
                        <div className='grid lg:grid-cols-4 md:grid-cols-4 sm:grid-cols-2 md:gap-4 gap-8 sm:p-10 p-4 mt-10'>
                            {
                                plansTypes.map((item, index) => (
                                    <RoundedBox key={item.name} className={clsx("max-h-[600px] min-h-[600px] plan-card relative !bg-transparent border border-blue-150 px-4 py-7 flex flex-col justify-between", index === 1 || index === 3 ? "sm:mt-24" : "",item.name?.toLowerCase())}>
