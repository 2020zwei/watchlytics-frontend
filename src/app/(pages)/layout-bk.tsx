...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen bg-gray-50">
      ...
      <aside className="hidden pb-10 fixed h-screen scrollable z-[999] md:block w-64 text-white flex-shrink-0 overflow-y-auto"
            style={{
      ...
      {/* Main Content */}
      <div className="flex-1 flex flex-col h-full md:ps-[280px]">
